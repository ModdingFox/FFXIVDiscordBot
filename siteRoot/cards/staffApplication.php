<div class="card-body d-none" id="applicationCardBody">
    ...
    <div class="row justify-content-center mb-4">
        <ul class="nav nav-pills card-header-pills">
            <li class="nav-item">
                <a class="nav-link mr-4 biosButton" id="previousApplicationButton" href="#application" onclick="getPreviousApplication()">Previous</a>
            </li>
            <li class="nav-item">
                <a class="nav-link mr-4 biosButton" id="nextApplicationButton" href="#application" onclick="getNextApplication()">Next</a>
            </li>
        </ul>
    </div>
    <div id="currentApplication">
        <label for="question1">Are you available to work 9pm to 2am, Tues and Wed? <span style="color:tomato;">*</span></label>
